...
var tagGen = [
    "gold=gears,plates,dusts",
    "diamond=gears,plates,dusts",
    "copper=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "tin=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "aluminum=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "lead=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "silver=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "nickel=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "bronze=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "enderium=storage_blocks,ingots,nuggets,dusts,ores,gears,plates",
    ...
    "tungsten=storage_blocks,ingots,nuggets,dusts,ores,gears,plates",
    "steel=storage_blocks,ingots,nuggets,dusts",
    "platinum=storage_blocks,ingots,nuggets,dusts,ores,raw_materials",
    "uranium=storage_blocks,ingots,nuggets,dusts,ores,raw_materials",
    "iridium=storage_blocks,ingots,nuggets,dusts,ores,raw_materials",
    "titanium=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials",
    "zinc=storage_blocks,ingots,nuggets,dusts,ores,raw_materials",
    "cinnabar=storage_blocks,ingots,nuggets,dusts,ores,raw_materials",
    "osmium=ingots,ores,raw_materials",
    "sulfur=dusts,ores",
    "silicon=gems"
]
